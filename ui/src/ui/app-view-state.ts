...
export type AppViewState = {
  ...
  platformAgents: import("./controllers/platform.js").PlatformAgent[] | null;
  ...
  platformSoulVersions: Array<{ version: number; createdAt: string }> | null;
  platformSoulVersionsLoading: boolean;
  platformSoulVersionsAgentId: string | null;
  platformAgentErrors: import("./controllers/platform.js").PlatformMetric[] | null;
  platformAgentErrorsLoading: boolean;
  platformAgentErrorsAgentId: string | null;
  platformErrorEvents: import("./controllers/platform.js").PlatformErrorEvent[] | null;
  platformErrorEventsLoading: boolean;
  platformErrorEventsAgentId: string | null;
  platformHealthSamples: import("./controllers/platform.js").PlatformHealthSample[] | null;
  ...
  platformShowCreateModal: boolean;
  platformCreateError: string | null;
  platformDeleteConfirmId: string | null;
  cronLoading: boolean;
  cronJobs: CronJob[];
